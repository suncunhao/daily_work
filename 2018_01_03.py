...
balance2['客户简称'] = balance2['客户名称'].str.split('-')
balance2['客户简称'] = balance2['客户简称'].apply(lambda x: x[0] if type(x) == list else x)
...
client_balance.to_csv('data_output/dateorder/20180104/client_balance_2017.csv')

balance1.to_csv('data_output/dateorder/20180104/balance1.csv')
balance2.to_csv('data_output/dateorder/20180104/balance2.csv')
balance3.to_csv('data_output/dateorder/20180104/balance3.csv')
